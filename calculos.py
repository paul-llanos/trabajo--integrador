...
def calculo_intensidad_cpu_usuarios(cpu_usada: float, usuarios_conectados: int) -> float:
    """
...
def calculo_de_cantidad_de_procesos_por_usuarios(usuarios_conectados: int, procesos_activos: int) -> float:
    """
...
def calculo_cantidad_de_errores_del_sistema(diagnostico_cpu: list, diagnostico_ram: list, diagnostico_usuarios:list ,diagnostico_procesos:list, diagnostico_disco:list, diagnostico_firewall:list , diagnostico_de_vulnerabilidad:list) -> int: 
    """
